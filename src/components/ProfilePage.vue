      ...
      <div class="author-info" :class="{ truncated: !detailsExpanded }">
        ...
        <div class="details">
          ...
          <div class="info-el">
            ...
            <ul
              v-if="artist.info.using.software.split(/, *(and)? */g).length > 1"
            >
              <li
          ...
          <div class="info-el">
            ...
            <ul
              v-if="artist.info.using.hardware.split(/, *(and)? */g).length > 1"
            >
              <li
          ...
          <div class="info-el">
            ...
            <ul v-if="artist.info.fav.general.split(/, *(and)? */g).length > 1">
              <li
          ...
          <div class="info-el">
            ...
            <ul v-if="artist.info.fav.albums.split(/, *(and)? */g).length > 1">
              <li
          ...
          <div class="info-el">
            ...
            <ul v-if="artist.info.fav.artists.split(/, *(and)? */g).length > 1">
              <li
